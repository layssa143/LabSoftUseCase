...
namespace AppTask.Controllers
{
    public class DepartamentoController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Codigo,DescricaoDepartamento,Ativo")] Departamento departamento)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Codigo,DescricaoDepartamento,Ativo")] Departamento departamento)
        {
